...
generate_figure_index <- function(viz_dir = "latest_visualization") {
  ...
  reg <- rbind(
    c("pipeline_cleaning/01_Final_Data_Quality_Dashboard.png", 1, "Usable? clean vs flagged (post-correction)"),
    c("pipeline_cleaning/12_Pipeline_Correction_Progress.png", 1, "Did cleaning converge across all 8 steps?"),
    c("pipeline_cleaning/P26_PerParticipant_Flag_Rate.png",    1, "Who to exclude? per-participant flag rate"),
    c("pipeline_cleaning/13_Error_Category_Distribution.png",  2, "Which error types dominate"),
    c("pipeline_cleaning/07_Flag_Composition_Stacked.png",     2, "Quality vs sleep-duration range"),
    c("pipeline_cleaning/11_Flag_Cooccurrence_Heatmap.png",    2, "Which issues co-occur"),
    c("pipeline_cleaning/16_Common_Error_Patterns.png",        2, "Most frequent error patterns"),
    c("pipeline_cleaning/15_Error_Timeline.png",               2, "When errors cluster over time"),
    c("pipeline_cleaning/17_Top_Participants_Flags.png",       2, "Top 15 flagged participants"),
    c("pipeline_cleaning/18_Auto_Detected_Dashboard.png",      2, "To-review vs already-corrected"),
    c("pipeline_cleaning/19_Unified_Quality_Status.png",       2, "Final unified quality status"),
    c("pipeline_cleaning/06_Sleep_Duration_Post_Correction.png", 2, "Duration: before vs after correction"),
    c("pipeline_cleaning/14_Sleep_Duration_Pre_Correction.png",  2, "Pre-correction (algorithm-only)"),
    c("pipeline_cleaning/08_Sleep_Duration_by_Category.png",   2, "Duration by clean/unusual/error"),
    c("pipeline_cleaning/10_Extreme_Sleep_Duration.png",       2, "Extreme durations + efficiency"),
