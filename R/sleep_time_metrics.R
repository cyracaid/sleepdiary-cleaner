# Internalised sleep-time metrics (was calculate_sleep_time_end.R)
#
# Copied verbatim from inst/scripts/ during TECH_DEBT item 4. The script
# copy is retained (00_MAIN_entry.R and the snapshot verifier still source
...
#' @keywords internal
#' @noRd
#' @importFrom dplyr mutate case_when if_else between n
#' @importFrom tidyr separate
#' @importFrom lubridate minutes interval duration period

# dplyr NSE column names inside the verbatim body (tidy-eval data variables).
# Registered here so R CMD check's undefined-global scan stays clean without
# touching the locked body.
utils::globalVariables(c(
  "time_bed_corrected", "time_sleep_corrected", "time_awake_corrected",
  "time_getup_corrected", "num_waso_estimate_am",
  ...
  "sol_duration_for_review_status", "waso_duration_for_metrics_status",
  "self_diffcalc_sleeponset", "self_diffcalc_sleepperiod_minutes",
  "self_diffcalc_totaltrysleep_minutes", "self_diffcalc_totalsleeptime_minutes"
))
